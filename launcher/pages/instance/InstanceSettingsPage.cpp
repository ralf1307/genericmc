    ...
    : QWidget(parent), ui(new Ui::InstanceSettingsPage), m_instance(inst)
{
    ...
    connect(GMC, &GenericMC::globalSettingsAboutToOpen, this, &InstanceSettingsPage::applySettings);
    connect(GMC, &GenericMC::globalSettingsClosed, this, &InstanceSettingsPage::loadSettings);
    loadSettings();
}
...
void InstanceSettingsPage::globalSettingsButtonClicked(bool)
{
    switch(ui->settingsTabs->currentIndex()) {
        case 0:
            GMC->ShowGlobalSettings(this, "java-settings");
            return;
        case 1:
            GMC->ShowGlobalSettings(this, "minecraft-settings");
            return;
        case 2:
            GMC->ShowGlobalSettings(this, "custom-commands");
            return;
    }
}
...
void InstanceSettingsPage::on_javaDetectBtn_clicked()
{
    ...
    VersionSelectDialog vselect(GMC->javalist().get(), tr("Select a Java version"), this, true);
