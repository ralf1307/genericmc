...
void CheckJava::executeTask()
{
    ...
    if (javaUnixTime != storedUnixTime || storedVersion.size() == 0 || storedArchitecture.size() == 0 || storedVendor.size() == 0)
    {
        ...
        emit logLine(QString("Checking Java version..."), MessageLevel::GenericMC);
...
void CheckJava::checkJavaFinished(JavaCheckResult result)
{
    switch (result.validity)
    {
        case JavaCheckResult::Validity::Errored:
        {
            ...
            emit logLine("\nCheck your MultiMC Java settings.", MessageLevel::GenericMC);
        ...
        case JavaCheckResult::Validity::ReturnedInvalidData:
        {
            ...
            emit logLine("\nMinecraft might not start properly.", MessageLevel::GenericMC);
            printSystemInfo(false, false);
            emitSucceeded();
            return;
        }
