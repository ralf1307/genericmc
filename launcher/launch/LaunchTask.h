...
public slots:
    void onLogLines(const QStringList& lines, MessageLevel::Enum defaultLevel = MessageLevel::GenericMC);
    void onLogLine(QString line, MessageLevel::Enum defaultLevel = MessageLevel::GenericMC);
