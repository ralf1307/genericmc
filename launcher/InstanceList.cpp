...
void InstanceList::deleteInstance(const InstanceId& id)
{
    ...
    qDebug() << "Instance" << id << "has been deleted by GenericMC.";
}
...
private:
     ...
     * Basically, it starts messing things up while GenericMC is extracting/creating instances
...
QString InstanceList::getStagedInstancePath()
{
    ...
    QString relPath = FS::PathCombine("_GMC_TEMP/" , key);
