    ...
    : QDialog(parent), ui(new Ui::IconPickerDialog)
{
    ...
    contentsWidget->setModel(GMC->icons().get());
...
void IconPickerDialog::addNewIcon()
{
    ...
    GMC->icons()->installIcons(fileNames);
}

void IconPickerDialog::removeSelectedIcon()
{
    GMC->icons()->deleteIcon(selectedIconKey);
}
...
{
    DesktopServices::openDirectory(GMC->icons()->getDirectory(), true);
}
