...
public:
    ...
    /***
     * the instance has been invalidated - it is no longer tracked by GenericMC for some reason,
    ...
    /// The instance's ID. The ID SHALL be determined by GMC internally. The ID IS guaranteed to
    /// be unique.
